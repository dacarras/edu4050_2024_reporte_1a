...
- Vamos a reproducir la proporción de estudiantes que alcanza el nivel mínimo de competencia lectora esperado, entre los estudiantes de 3er grado de ERCE 2019.
...
knitr::include_graphics('./reporte_1a_cifra.png')
```
...
# a la función `survey::svymean` para obtener medias de valores plausibles.
...
- Describa la proporción de estudiantes que alcanza el nivel mínimos de comprensión lectora en la región, para los estudiantes de tercer grado.
...
- Exporte la tabla de resultados a un archivo excel llamado "table_minimum_reading_proficiency_3th_graders.xlsx".
